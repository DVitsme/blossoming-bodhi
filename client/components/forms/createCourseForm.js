...
import { StepOne } from './courseSteps/stepOne';
...
const CreateCourseForm = ({
  ...
  if (step === 1) return <StepTwo nextStep={nextStep} prevStep={prevStep} />;
  if (step === 2) return <StepThree nextStep={nextStep} prevStep={prevStep} />;
  return (
    <StepOne
      values={values}
      setValues={setValues}
